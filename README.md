Bienvenidos al repositorio donde albergaremos nuestro Proyecto Final de SMR.

Nosotros nos hemos decantado por realizar una página web de un gimnasio que hemos nombrado IronForge, en este hemos intentado dar una oferta competitiva en una ubicación adecuada.

Se puede observar que tenemos un archivo index.html, esto lo hemos realizado así ya que teníamos los archivos dentro de otros directorios y cuando hemos percatado de ello la única solución 
